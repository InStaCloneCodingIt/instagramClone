...
<main id="login">
    <div class="login__column">
        <img src="/img/phoneImage.png" alt="깨짐?"/>
    </div>
    <div class="login__column">
        <div class="login__box">
          ...
          or
            ...
            <a href="/auth/kakao/login" class="login__fb-link">
                <img width="100%" src="/img/kakao_account_login_btn_medium_wide.png"/>
            </a>
        ...
        <span class="login__text">
          Get the app.
            ...
            <div class="login__appstores">
                <img src="/img/ios.png" class="login__appstore" />
                <img src="/img/android.png" class="login__appstore" />
            </div>
        </div>
    </div>
</main>
